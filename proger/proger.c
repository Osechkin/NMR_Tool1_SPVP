...
{
	volatile unsigned int grad_status;

	grad_status  = proger_rd_reg_32(MEM_ADDR_GRAD_STATUS_REG);

	return (grad_status);
}// proger_read_grad_status
/*---------------------------------------------------------------------------*/
...
unsigned int proger_start_grad ()
{
	...
	proger_wr_reg_32 (MEM_ADDR_GRAD_CONFIG_REG, 0x01);
	proger_wr_reg_32 (MEM_ADDR_GRAD_CONFIG_REG, 0x00);
