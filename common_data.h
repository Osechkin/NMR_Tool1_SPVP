...
#define DATA_HEAP_COUNT		(2048)			// количество массивов в куяе для долгосрочного хранения данных
...
typedef struct DataSample
{
	...
	uint8_t		tag;								// дополнительное поле для отладочных целей или прочих целей пользователя
} DataSample;
